...
public class MapsController : ControllerBase
{
    ...
    public MapsController(IMapDataAccess
    robotCommandsRepo)
    {
        _mapsRepo = robotCommandsRepo;
    }

    [HttpGet] // Return all maps as JSON
    public IEnumerable<Map> GetAllMaps()
    {
        //Return all the maps using the method GetAllMaps() from the class _mapsRepo
        return _mapsRepo.GetAllMaps();
    }
    ...
    public IActionResult AddMap(Map newMap)
    {
        ...
        Map? mapExists = _mapsRepo.GetMapByName(newMap.Name);
        ...
        try
        {
            ...
            Map? addedNewMap = _mapsRepo.GetMapByName(newMap.Name);
    ...
    {
        // Find the map by id
        Map existingMap = _mapsRepo.GetMapById(id);
